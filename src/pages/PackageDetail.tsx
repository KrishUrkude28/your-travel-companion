...
const PackageDetail = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        "We'll get back to you within 24 hours to confirm your trip.",
    });
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[50vh] md:h-[60vh]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, hsla(200,30%,10%,0.2) 0%, hsla(200,30%,10%,0.75) 100%)",
          }}
        />
        <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 container mx-auto">
          <Link to="/#packages">
            <motion.div
              ...
              className="inline-flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground text-sm mb-4 transition-colors cursor-pointer"
            >
          ...
          >
            <span className="px-3 py-1 rounded-full bg-accent/90 text-accent-foreground text-xs font-semibold mb-3 inline-block">
              {pkg.type}
            </span>
            ...
            <div className="flex flex-wrap items-center gap-4 text-primary-foreground/80 text-sm">
              ...
              <span className="flex items-center gap-1">
                <Users className="h-4 w-4" /> {pkg.groupSize}
              </span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="bg-card rounded-xl p-6 shadow-card">
                ...
                <ul className="space-y-3">
                  {pkg.inclusions.map((item) => (
                    ...
                    >
                      <Check className="h-4 w-4 text-forest-green shrink-0 mt-0.5" />
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="bg-card rounded-2xl p-6 shadow-elevated sticky top-6"
            >
